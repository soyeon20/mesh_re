...
import com.choice.food.service.board.BoardPager;
import com.choice.food.service.board.BoardService;
...
public class BoardController {
	...
	public ModelAndView list(@RequestParam(defaultValue="title") String searchOption,
            ...
            @RequestParam(defaultValue="1") int curPage) throws Exception{
			 ...
			 // 레코드의 갯수 계산
		    int count = boardService.countArticle(); //boardService.countArticle(searchOption, keyword);
		    System.out.println(count+"됐다ㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏ");
